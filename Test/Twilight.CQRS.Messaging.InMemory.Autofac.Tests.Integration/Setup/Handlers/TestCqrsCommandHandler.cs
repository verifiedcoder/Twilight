...
internal sealed class TestCqrsCommandHandler(
    ...
    IValidator<CqrsCommand<TestParameters>> validator) : CqrsCommandHandlerBase<TestCqrsCommandHandler, CqrsCommand<TestParameters>>(messageSender, logger, validator)
{
